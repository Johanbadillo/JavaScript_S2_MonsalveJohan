    ...
    \n==========================================="
            ...
            \n==========================================="
                    ...
                    if (Popciones == "1") {
                        ...
                        let ingredientes = []
                        alert("Ingrese los ingredientes de a uno(Ingrese '0' para terminar de ingresar ingredientes).")
                        continuar = true
                        while (continuar == true) {
                            let ingrediente = prompt("Ingrese el ingredientes(Ingrese '0' para terminar de ingresar ingredientes). ");
                            if (ingrediente === "0") {
                                continuar = false;
                            } else if (ingrediente) {
                                ingredientes.push(ingrediente.trim());
                                alert("Ingrediente Añadido: " + ingrediente);
                            } else {
                                alert("Porfavor ingrese algun ingrediente x_x")
                            }
                        }
